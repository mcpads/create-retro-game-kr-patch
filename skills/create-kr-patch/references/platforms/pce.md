...
Hangul visibility through a BIOS font path proves only that path. It does not prove new code space, complete glyph supply, or another renderer. Judge remaining conditions through PoCs in `references/strategy/poc.md`.
