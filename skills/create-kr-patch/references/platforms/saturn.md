...
PT0402에서 자기 round-trip과 게임 소비가 갈린 구체 사례는 현재 조건이 맞을 때만 `references/tips/saturn.md`의 SATURN-003에서 읽는다.
...
구체 실패는 현재 증상과 타이틀이 맞을 때만 `references/tips/saturn.md`에서 선택해 읽는다.
