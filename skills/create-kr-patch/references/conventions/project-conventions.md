...
|---|---|---|---|
| Tooling build | The patcher, analyzer, verifier, or supporting code must be compiled or packaged. | The required tooling can be produced under the declared toolchain. | A tooling build does not run analysis, construct or verify the current product artifact, or establish runtime behavior. |
