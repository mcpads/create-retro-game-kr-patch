...
- **Discriminating evidence:** Stale tiles were observed at the failure point and compared with normal messages drawn after a clear. Callers lacking a clear were enumerated, and only the failing caller was redirected through an existing clear-capable path.
