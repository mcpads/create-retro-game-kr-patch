...
- **Discriminating evidence:** The truncated output was parsed again with the same tokenizer. Removing an incomplete final token and returning to the previous character boundary removed the failure.
