...
- **Transfer limit:** Evidence extends to paths with established reference, loading, and consumer equivalence. Resolve differences in region boundaries, alignment, termination, load size, display, interaction, or progress before extending the claim.
