...
- **Discriminating evidence:** Every parser-reachable two-byte pair in the source was counted, game-specific pairs were reserved, and the Hangul encoder was verified not to emit them.
