...
- **Discriminating evidence:** ROM frequency and context, runtime samples, and another source version established the punctuation. Every Korean asterisk position was then audited, retranslated where affected, and cross-reviewed.
