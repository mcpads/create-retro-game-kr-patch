...
- **Transfer limit:** Re-derive candidate order, edit stages, record structure, supported repertoire, save format, and every consumer. A reset or power-cycle observation in the same emulator process does not prove persistence after restarting the emulator, and representative names do not provide human visual approval of the complete repertoire.
