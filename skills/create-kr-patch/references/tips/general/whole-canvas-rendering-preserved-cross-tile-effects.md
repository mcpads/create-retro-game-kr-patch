...
- **Evidence:** The complete label was composed as one canvas, then split according to the verified tile, subtile, palette, storage, and transfer order. Runtime observations on multiple entry screens confirmed that the seams and effects remained intact.
