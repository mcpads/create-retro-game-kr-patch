...
- **Discriminating evidence:** Unmodified decompressed Japanese data was recompressed and reproduced the defect in the game while still passing the custom round-trip, isolating a semantic difference from the game decompressor.
...
- **Transfer limit:** A self round-trip does not prove target-consumer compatibility. Verify an unmodified recompressed asset in the real consumer.
