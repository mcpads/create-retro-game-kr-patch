...
- **Discriminating evidence:** Slot width and count were derived from the consumer, every slot containing text and every blank slot was written to the exact width, and the final slots were observed through reuse.
