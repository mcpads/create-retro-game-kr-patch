...
- **Discriminating evidence:** Background and sprite consumers were traced separately, the sprite was rebuilt from the final Korean background, and both entry paths were checked while the palette cycled.
