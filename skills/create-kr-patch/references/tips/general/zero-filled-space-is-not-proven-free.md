...
- **Discriminating evidence:** The first invalid instruction exposed overwritten conversion code and constants. After they were restored and the connected tables were relocated with all references fixed, the title booted cleanly and gameplay proceeded. Saturn candidates were observed with isolated trap artifacts along the same play path; non-execution was recorded only for the observed path.
