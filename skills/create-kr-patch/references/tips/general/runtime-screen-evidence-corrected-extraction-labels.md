...
- **Discriminating evidence:** The segment's tile indices were decoded directly from the binary and their assembly order was retraced.
...
- **Transfer limit:** A removal experiment cannot isolate a labeling error if it also changes the input data or assembly order.
