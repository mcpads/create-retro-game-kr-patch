...
- **Discriminating evidence:** Each target token handler, pointer mapping, glyph mapping, and runtime value was compared with its source. Only confirmed static values became localized text, while position-control codes remained reserved from glyph allocation.
