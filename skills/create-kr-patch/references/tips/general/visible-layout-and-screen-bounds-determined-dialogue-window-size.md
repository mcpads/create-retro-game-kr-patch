...
- **Observed scope:** Dynamic battle-dialogue window sizing for Korean text in an SNES title.
...
- **Evidence:** Korean text was tokenized like the consumer. Controls were excluded from width, line changes determined row count, and the resulting window was independently clamped to the actual screen boundary. Runtime observations in battle scenes confirmed both the window size and text layout.
