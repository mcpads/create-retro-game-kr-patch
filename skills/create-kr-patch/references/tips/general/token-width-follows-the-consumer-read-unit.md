...
- **Discriminating evidence:** The consumer's two-byte read and advance were confirmed. Serializing every token as a word and rejecting controls at odd positions removed the alignment failure.
