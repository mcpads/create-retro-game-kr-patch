...
- **Discriminating evidence:** Entry and return register meanings were compared across every caller of the shared routine. Preserving `B` and normalizing each caller's graphics-plane state restored glyph expansion and transfer on dialogue and field paths.
