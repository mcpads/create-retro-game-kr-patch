...
- **Transfer limit:** Observe from before the relevant load or write. A checkpoint from the same product artifact before that boundary can suffice; otherwise cross it in a new run.
