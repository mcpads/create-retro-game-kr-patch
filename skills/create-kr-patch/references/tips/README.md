...
| Token width follows the consumer read unit | Text extraction / Initial survey | One-byte controls misalign a consumer that always reads two bytes | SNES | `references/tips/general/cases.md#token-width-follows-the-consumer-read-unit` |
