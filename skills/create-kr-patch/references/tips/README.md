...
중간 조사·archive·journal은 당시의 가설을 복원하는 증거이지 현재 결론의 정본이 아니다. 사례를 추가하거나 고칠 때는 현 코드와 후속 상태 문서·커밋까지 확인해 가설이 뒤집히거나 해결되지 않았는지 대조한다. 최종 판정을 복원하지 못하면 미해결 가설을 성공 사례로 승격하지 말고 해당 항목을 두지 않는다.
