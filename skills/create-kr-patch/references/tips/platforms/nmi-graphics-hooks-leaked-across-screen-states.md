...
- **Discriminating evidence:** The new signal was removed. The NMI consumer instead checked the current screen mode, BG1 tilemap base, and original tilemap pattern together. A counterexample screen that matched only the global state was excluded, and the overwrite then ran only on the intended screen.
