...
- **Transfer limit:** Validate OBJ tile transfer separately from OAM layout. Reuse evidence where transfer conditions are equivalent; investigate differences in display-off timing, DMA restoration, destination, palette, last writer, or trigger.
