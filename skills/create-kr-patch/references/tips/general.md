...
여기에는 대상 포맷의 문법보다 증거의 출처·적용 시점, 파생물의 갱신, 실험 설계, 번역·검토 맥락, 도구와 실제 소비자의 차이, 후보 공간의 실행 여부가 선택 조건인 사례를 둔다. 이 파일은 보편 규칙이나 잡학을 모은 문서가 아니다. ID 접두사는 실제 관측 플랫폼을 나타내며, 현재 판단 영역과 발동 조건이 맞을 때만 `references/tips/README.md`에서 해당 절을 골라 읽는다.
