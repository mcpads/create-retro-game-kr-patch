...
Do not merge unresolved into excluded. A non-text exclusion is a technical conclusion supported by consumer or structural evidence; an out-of-scope exclusion cites the recorded human decision that defines the scope under `references/conventions/project-records.md` §1.1. If the denominator is not established, report remaining investigation rather than completion.
