...
텍스트 추출의 목표는 “읽을 수 있는 문자열을 많이 찾는 것”이 아니다. 배포 범위의 소비 가능한 텍스트 모집단을 확정하고, 원본 코드·제어 토큰·경계·참조 관계를 재삽입 가능한 형태로 보존하는 것이다. 후보 탐색 기법이나 특정 분석 도구는 프로젝트가 정하며, 이 문서는 완료 판정만 소유한다.
