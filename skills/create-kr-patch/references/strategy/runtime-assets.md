...
5. When a new or changed load can affect shared execution or transfer state, does it preserve concurrent audio, input, and display state within that impact range?
